...
import { createChatList, createMessage, getAllChatForAdmin, getAllChatForUser, getMessageByChatId } from "./chat.controller";
...
router.get("/get-chat-admin/:id",isValidate, getAllChatForAdmin);
